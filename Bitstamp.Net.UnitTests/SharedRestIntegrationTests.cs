...
namespace Bitstamp.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private static SharedSymbol _futuresSymbol = new SharedSymbol(TradingMode.PerpetualLinear, "BTC", "USD");
        ...
        private IBitstampRestClientExchangeApiShared GetRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddBitstamp(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IBitstampRestClient>().ExchangeApi.SharedClient;
        }
