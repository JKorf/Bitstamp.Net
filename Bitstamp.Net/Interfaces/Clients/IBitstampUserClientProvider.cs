...
namespace Bitstamp.Net.Interfaces.Clients
{
    ...
    public interface IBitstampUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, ApiCredentials credentials, BitstampEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IBitstampRestClient GetRestClient(string userIdentifier, ApiCredentials? credentials = null, BitstampEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IBitstampSocketClient GetSocketClient(string userIdentifier, ApiCredentials? credentials = null, BitstampEnvironment? environment = null);
    }
}