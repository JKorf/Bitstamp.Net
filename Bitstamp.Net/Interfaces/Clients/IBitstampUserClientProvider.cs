...
namespace Bitstamp.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IBitstampUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, BitstampCredentials credentials, BitstampEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IBitstampRestClient GetRestClient(string userIdentifier, BitstampCredentials? credentials = null, BitstampEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IBitstampSocketClient GetSocketClient(string userIdentifier, BitstampCredentials? credentials = null, BitstampEnvironment? environment = null);
    }
}